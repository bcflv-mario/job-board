...
export default function Home({ jobs, user }) {
  ...
  return (
    <div className='mt-10'>
      ...
      {!session && (
    <a className='border pl-16 px-8 py-2 mt-5 font-bold rounded-full bg-black text-white border-black '
        href='/api/auth/signin'>
      login
    </a>
  )}
   {session && session.user.name && (
    <div className='border-spacing-44 pl-16 px-8 py-2 mt-5 font-bold rounded-full bg-black text-white border-black '>
